...
<?PHP
    ...
    static function HistoryPrice($stock,$date){ // this function use to retrieve history stock information from 2014 to 2015. input should be a specific stock symbol
        if($date==0)
        $requestUrl ="http://ichart.yahoo.com/table.csv?s=".$stock."&a=2&b=31&c=2014&d=2&e=31&f=2015&g=d&ignore=.csv";
        echo $date;
        if($date!=0)
         $requestUrl ="http://ichart.yahoo.com/table.csv?s=".$stock."&a=3&b=".$date."&c=2014&d=3&e=".$date."&f=2015&g=d&ignore=.csv";
        $filesize=200000;

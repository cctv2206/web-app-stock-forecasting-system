...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    construct: function (a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) ||
            !this.foundGraphs || Infinity == this.min || -Infinity == this.max) c = !0;
        else {
        ...
        for (k = this.start; k <= this.end; k++) {
            ...
            for (n = 0; n < h.length; n++)
                ...
                if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g)) m.newStack && (e[k] = NaN, d[k] =
                    NaN);
                else {
        ...
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)(m = h[n], m.hidden) ? m.newStack && (e[k] = NaN, d[k] = NaN) : (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = g / f[k] * 100, l.values.percents = c, l.values.total = f[k], m.newStack &&
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                var f, g, h = this.end + 2,
                    h = AmCharts.fitToBounds(this.end + 1,
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l, m, n) {
        ...
        W && (W.attr({
                "text-anchor": ha
            }), W.translate(G, v), 0 !== m && W.rotate(-m, a.chart.backgroundColor), a.allLabels.push(W), this.label =
...
AmCharts.AmChart = AmCharts.Class({
    construct: function (a) {
        ...
        }, handleWheelReal: function (a) {}, addListeners: function () {
            var a = this,
                b = a.chartDiv;
        ...
        handleMouseOver: function (a) {
        ...
        }, handleReleaseOutside: function (a) {}, handleMouseDown: function (a) {
            AmCharts.resetMouseOver();
            this.mouseIsOver = !0;
            ...
            if ("amcharts.com" != b || !0 === this.inIframe()) {
                ...
                var f = "",
                    ...
                    h = "";
                "ammap" ==
                this.product && (f = "http://www.ammap.com/javascript-maps/", g = "Interactive JavaScript maps", h = "JS map by amCharts");
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
                ...
                if (Aa) {
                    ...
                    case "smoothedLine":
                        if (isNaN(V)) z || (this.drawSmoothedGraph(x, u, P, Q), x = [], u = [], P = [], Q = []);
                            ...
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib) x.push(F), u.push(E), gb = F, hb =
                                E;
                            xa = F;
                            ya = E;
                            fa = F;
                        ...
                        if (!isNaN(V)) {
                            ...
                            if (!(V < Kb && la < Kb || V > Lb && la > Lb)) {
                                ...
                                if (r) {
                                    ...
                                    N < n && 0 < L && (na = new AmCharts.Cuboid(e,
                                    ...
                                    R < m + Z * D && 0 < L && (this.showOnAxis && (N -= I / 2), na = new AmCharts.Cuboid(e, L,
                            ...
                            if (na && (wa = na.set, AmCharts.setCN(a, na.set, "graph-" + this.type), AmCharts.setCN(a, na.set, "graph-" + this.id), v.className && AmCharts.setCN(a, na.set, v.className, !0), v.columnGraphics = wa, wa.translate(R, N), this.columnsSet.push(wa), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), !S)) {
                                ...
                                "3d" == X && (r ? (H = (this.end + 1 - J) * B - c - 1E3 * this.depthCount,
                                    xa += D * this.columnIndex, fa += D * this.columnIndex, v.y += D * this.columnIndex) : (H = (B - c) * (J + 1) + 1E3 * this.depthCount, ya += I * this.columnIndex, ga += I * this.columnIndex, v.y += I * this.columnIndex));
                    ...
                    case "candlestick":
                        if (!isNaN(la) && !isNaN(V)) {
                            ...
                            na && (wa = na.set, v.columnGraphics = wa, ba.push(wa), wa.translate(R, N - Y / 2), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), Ta && (ba.push(Ta), ba.push($a)),
                                xa = F, ya = E, r ? (ga = E, fa = F, "open" == k && (fa = M), "high" == k && (fa = Na), "low" == k && (fa = Ma)) : (ga = E, "open" == k && (ga = K), "high" == k && (ga = Da), "low" == k && (ga = Ca), fa = F), S || (v.x = r ? N + L / 2 : R + L / 2, this.animateColumns(na, J, F, M, E, K), this.addListeners(wa, v)))
                        }
                        break;
                    case "ohlc":
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" ==
                g ? this.drawSmoothedGraph(x, u, P, Q) : this.drawLineGraph(x, u, P, Q), S || this.launchAnimation();
            ...
            if (1 < a.length) {
                ...
                m =
                    AmCharts.line(h, a, b, p, m, n, z, !1, !0);
                ...
                if (0 < f || 0 < u)
                    if (n = a.join(";").split(";"), r = b.join(";").split(";"), m = g.type, "serial" ==
        ...
        launchAnimation: function () {
            ...
            if (!isNaN(b) && !isNaN(c)) {
                ...
                if (this.customBullet || a.customBullet) r = this.customBullet, a.customBullet && (r = a.customBullet), r && (p && p.remove(), "function" == typeof r ? (p = new r, p.chart = d, a.bulletConfig && (p.availableSpace =
                ...
                p && ((a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer"), "serial" == d.type && (-.5 > b - 0 || b - 0 > this.width || c < -g / 2 || c - 0 > this.height) && (p.remove(), p = null), p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p)), a.bx =
                    b, a.by = c, AmCharts.setCN(d, p, this.bcn + "bullet"), a.className && AmCharts.setCN(d, p, a.className, !0));
            ...
            for (b = 0; b < a.length; b++) a[b].graphDataItem.customBullet &&
                a[b].show()
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function (a) {
            ...
            d || (d = b.valueAxes[0]);
            a.valueLineAxis = d;
            a.valueLineBalloonEnabled && (d = new AmCharts.AmBalloon, d.chart = b, a.vaBalloon = d, AmCharts.copyProperties(c,
            ...
            0 < this.cursorAlpha && (d.show(), e.show(), d.translate(b, 0),
                e.translate(0, c));
            ...
            var c = this.selectionPosX,
                ...
                h = this.height;
            isNaN(a) || (c >
                a && (e = a, g = c - a), c < a && (e = c, g = a - c), c == a && (e = a, g = 0), g += this.extraWidth, e -= this.extraWidth / 2);
                            ...
                            if (a != this.previousIndex || H != this.previousMostCloseGraph)
                                if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                    ...
                                    for (g = 0; g < B.length; g++)
                                        if (u =
                                            B[g], x = NaN, (!this.oneBalloonOnly || u == H) && u.showBalloon && !u.hidden && u.balloonText && ("step" == u.type && "left" == u.stepDirection && (r = this.data[a + 1]), r)) {
    ...
    construct: function (a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m =
                    AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), p = 0, m = l, n = l / 3;
                else {
                    var r;
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if (d) f.value ? e.text(f.value) : e.text("");
                ...
                } else g = b.formatString(this.valueText, f); if (k = this.valueFunction) h && (f = h), g = k(f, g);
                e.text(g)
            }
        }
    }, renderFix: function () {

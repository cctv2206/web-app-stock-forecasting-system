AmCharts.AmStockChart = AmCharts.Class({
    construct: function (a) {
            ...
            c && AmCharts.AmExport && !this.AmExport && (this.AmExport = new AmCharts.AmExport(this,
                c));
            ...
            this.chartCursorSettings =
                AmCharts.processObject(this.chartCursorSettings, AmCharts.ChartCursorSettings, b);
            ...
            this.dataSetSelector &&
                (this.dataSetSelector = AmCharts.processObject(this.dataSetSelector, AmCharts.DataSetSelector, b));
            ...
            }!a && AmCharts.ifArray(b) && (this.mainDataSet =
                this.dataSets[0])
        ...
        getFirstDate: function (a) {
            ...
            if (a) {
                ...
                this.glueToTheEnd && this.startDate && this.endDate &&
                    this.lastDate && (AmCharts.getPeriodDuration(b.minPeriod), this.startDate = new Date(this.startDate.getTime() + (this.lastDate.getTime() - this.endDate.getTime())), this.endDate = this.lastDate, this.updateScrollbar = !0);
            ...
            for (c = 0; c < a.length; c++) {
                var d = a[c];
                d.dataParsed || (AmCharts.parseStockData(d, b.minPeriod, b.groupToPeriods, this.firstDayOfWeek,
            ...
            if ("left" == b || "left" == c) a = document.createElement("div"), a.className = d + "-left-div", a.style.cssFloat = "left", a.style.styleFloat = "left", a.style.width = "0px", a.style.position = "absolute",
                e.appendChild(a), this.leftContainer = a;
            ...
            for (e = 0; e < a.length; e++) k = a[e], k.percentHeight = k.percentHeight / d * 100, k.panelBox && (k.panelBox.style.height = Math.round(k.percentHeight * this.panelsHeight / 100) + "px")
            ...
            if (d = a.stockLegend) d = AmCharts.processObject(d, AmCharts.StockLegend, this.theme), d.container = void 0, d.title = a.title,
                d.marginLeft = c.marginLeft, d.marginRight = c.marginRight, d.verticalGap = 3, d.position = "top", AmCharts.copyProperties(this.legendSettings, d), a.addLegend(d, d.divId);
            a.zoomOutText = "";
            this.addCursor(a)
            ...
            if (a) {
                ...
                b && (c = this.categoryAxesSettings, d = c.minPeriod, b.categoryField = a.categoryField, 0 < a.dataProvider.length ? (e = this.chartScrollbarSettings.usePeriod, b.dataProvider = e ? a.agregatedDataProviders[e] : a.agregatedDataProviders[d]) : b.dataProvider = [], e = b.categoryAxis, e.minPeriod = d, e.firstDayOfWeek =
                    this.firstDayOfWeek, e.equalSpacing = c.equalSpacing, e.axisAlpha = 0, e.markPeriodChange = c.markPeriodChange, b.bbsetr = !0, b.validateData(), c = this.panelsSettings, b.maxSelectedTime = c.maxSelectedTime, b.minSelectedTime = c.minSelectedTime);
            ...
            if (a.enabled) {
                ...
                if (AmCharts.isString(d)) {
                    ...
                    for (e = 0; e < c.length; e++) {
                        var k =
                            AmCharts.getObjById(c[e].stockGraphs, a.graph);
                        k && (d = k)
                    }
                    a.graph = d
                }
                var h;
                d && (h = new AmCharts.AmGraph(this.theme), h.valueField = d.valueField, h.periodValue = d.periodValue, h.type = d.type, h.connect = d.connect, h.minDistance = a.minDistance, b.addGraph(h));
                ...
                "bottom" == a.position ? c ? "bottom" == c.position ? e.insertBefore(h, d) : e.appendChild(h) : e.appendChild(h) : c ? "top" == c.position ? e.insertBefore(h, d.nextSibling) : e.insertBefore(h, e.firstChild) : e.insertBefore(h, e.firstChild);
                b.write(h)
            }
        ...
        handlePeriodSelectorZoom: function (a) {
            ...
            if (b.enabled) {
                ...
                a.addChartCursor(c);
                this.listenTo(c,
                    "changed", this.handleCursorChange);
            ...
            if (e && k) {
                ...
                d.extendToFullPeriod && (g.getTime() - e.getTime() < .1 * z && (g = AmCharts.resetDateToMin(a, m.period, m.count, x)), k.getTime() - b.getTime() < .1 * z && (b = AmCharts.resetDateToMin(k, m.period, m.count, x), b = AmCharts.changeDate(b, m.period, m.count, !0)));
                for (e = 0; e < p.length; e++) k = p[e], k.chartCursor && k.chartCursor.panning && (g = c);
                for (e = 0; e < p.length; e++) {
                    k = p[e];
                    if (h != f) {
                        for (c = 0; c < r.length; c++) z = r[c].graph, z.dataProvider = z.dataSet.agregatedDataProviders[h];
                        c = k.categoryAxis;
                        c.firstDayOfWeek = x;
                        c.minPeriod = h;
                        k.dataProvider = d.mainDataSet.agregatedDataProviders[h];
                        if (c = k.chartCursor) c.categoryBalloonDateFormat = d.chartCursorSettings.categoryBalloonDateFormat(m.period), k.showCategoryAxis || (c.categoryBalloonEnabled = !1);
                ...
                d.endDate = b;
                n && n.zoom(a, b);
                if (a.getTime() != d.previousStartDate.getTime() || b.getTime() != d.previousEndDate.getTime()) n = {
                    type: "zoomed"
                }, n.startDate = a, n.endDate = b, n.chart = d, n.period = h, d.fire(n.type, n), d.previousStartDate = new Date(a), d.previousEndDate = new Date(b)
            }
            d.eventsHidden && d.showHideEvents(!1);
            d.chartCreated || (h = "init", d.fire(h, {
                type: h,
                chart: d
            }));
            d.chartRendered ||
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (h = 0; h < k.length; h++) {
                        ...
                        var w = c.stockLegend,
                            x, m, z, A;
                        w && (w = AmCharts.processObject(w, AmCharts.StockLegend, this.theme), c.stockLegend = w, x = w.valueTextComparing, m = w.valueTextRegular, z = w.periodValueTextComparing, A = w.periodValueTextRegular);
                        if (f.comparable) {
                            var y = e.length;
                            if (f.valueAxis) {
                                ...
                                for (C = 0; C < y; C++) {
                                    ...
                                    t.dataSet = B;
                                    t.behindColumns = f.showBalloon;
                                    t.showBalloon = f.behindColumns;
                                    ...
                                    g = !1;
                                    l = B.fieldMappings;
                                    for (n = 0; n < l.length; n++) p = l[n], p.toField == u && (g = !0);
                                    if (g) {
                                        t.valueField = u;
                                        t.title = B.title;
                                        t.lineColor = B.color;
                                        ...
                                        if (g = f.compareGraphNegativeFillColors) t.negativeFillColors = g;
                                        if (g = f.compareGraphFillAlphas) t.fillAlphas = g;
                                        if (g = f.compareGraphNegativeFillAlphas) t.negativeFillAlphas = g;
                                        if (g = f.compareGraphBullet) t.bullet = g;
                                        if (g = f.compareGraphNumberFormatter) t.numberFormatter = g;
                                        ...
                                        if (g = f.compareGraphBulletBorderColor) t.bulletBorderColor = g;
                        ...
                        w && (r && x ? (f.legendValueText = x, f.legendPeriodValueText = z) : (m && (f.legendValueText = m), f.legendPeriodValueText = A))
                    }
                }
            }
            ...
            var d = this.categoryAxesSettings,
                ...
                f = AmCharts.getPeriodDuration(f.period,
                    f.count),
                g = b.getTime(),
                l = c.getTime(),
                n = d.maxSeries;
            d.alwaysGroup && k == d.minPeriod && 1 < e.length && (k = e[1]);
            return (l - g) / f > n && 0 < n && h ? this.choosePeriod(a + 1, b, c) : k
            ...
            for (k = 0; k < e.length; k++) {
                var h = e[k];
                h != b && c && (h.isZooming(d), h.previousMousePosition = NaN, h.forceShow = !0, h.initialMouse = b.initialMouse, h.selectionPosX = b.selectionPosX, h.setPosition(c, !1, a))
            }
            ...
            this.measure();
            if (this.divRealWidth != this.previousWidth || this.divRealHeight != this.previousHeight) 0 < this.divRealWidth && 0 < this.divRealHeight &&
                this.fire("resized", {
                    type: "resized",
                    chart: this
...
AmCharts.PeriodSelector = AmCharts.Class({
    construct: function (a) {
        ...
        var b = this.dateFormat,
            ...
            b = this.chart.getLastDate(AmCharts.stringToDate(this.endDateField.value,
                b));
        try {
        ...
        var d = a.button,
            ...
            k = d.period,
            h = this.chart,
            f, g, l = this.firstDate,
            n = this.lastDate,
            p, r = this.theme;
        l && n && ("MAX" == k ? (f = l, g = n) : "YTD" == k ? (f = new Date, f.setMonth(0, 1), f.setHours(0, 0, 0, 0), 0 === e && f.setDate(f.getDate() - 1), g = this.lastDate) : "YYYY" == k || "MM" == k ? this.selectFromStart ? (f = l, g = new Date(l), g.setMonth(g.getMonth() + e)) : (f = new Date(n), AmCharts.changeDate(f, k, e, !1), f.setDate(f.getDate() - 1), g = n, f.setTime(f.getTime() + 1)) : (p = AmCharts.getPeriodDuration(k, e), this.selectFromStart ? (f = l, g = new Date(l.getTime() + p - 1)) : (f = new Date(n.getTime() - p + 1), g = n)), a.startTime = f.getTime(), this.hideOutOfScopePeriods && (b && a.startTime <
            l.getTime() ? d.style.display = "none" : d.style.display = "inline"), f.getTime() > n.getTime() && (p = AmCharts.getPeriodDuration("DD", 1), f = new Date(n.getTime() - p)), f.getTime() < l.getTime() && (f = l), "YTD" == k && (a.startTime = f.getTime()), a.endTime = g.getTime(), b || (this.skipMark = !0, this.unselectButtons(), d.className = "amChartsButtonSelected " + h.classNamePrefix + "-period-input-selected", r && AmCharts.applyStyles(d.style, r.PeriodButtonSelected), a = {
                type: "changed"
            }, a.startDate = f, a.endDate = g, a.predefinedPeriod = k, a.chart = this.chart,
            a.count = e, a.event = c, this.fire(a.type, a)))
...
AmCharts.parseStockData = function (a, b, c, d, e) {
    ...
    if (f) {
        ...
        for (n = 0; n < p; n++) {
            var A = h[n],
                y = A[f],
                y = y instanceof Date ? AmCharts.newDate(y, b) : e ? AmCharts.stringToDate(y, e) : new Date(y),
                C = y.getTime(),
                B = {};
            ...
            for (t = g; t < l; t++) {
                ...
                if (t == g || C >= w[r] || !w[r]) {
                    ...
                    var E;
                    for (E = 0; E < z; E++) u = m[E].toField, v = x[r], q = Number(B[u]), v[u + "Count"] = 0, v[u + "Sum"] = 0, isNaN(q) || (v[u + "Open"] = q, v[u + "Sum"] = q, v[u + "High"] = q, v[u + "Low"] = q, v[u + "Close"] = q, v[u + "Count"] = 1, v[u + "Average"] = q);
                    v.dataContext = A;
                    k[r].push(x[r]);
...
AmCharts.parseEvents = function (a, b, c, d, e, k) {
    ...
    for (l = 0; l < g; l++) {
        ...
        p = w.length;
        var A;
        for (n = 0; n < p; n++) r = w[n], r.customBulletField = "amCustomBullet" + r.id + "_" + x.id, r.bulletConfigField = "amCustomBulletConfig" + r.id + "_" + x.id;
        for (var y = 0; y < h.length; y++)
            if (m = h[y], A = m.graph, AmCharts.isString(A) && (A = AmCharts.getObjById(w, A))) m.graph = A
    }
    for (var C in f)
                    ...
                    for (x = b[l], w = x.graphs, p = w.length, n = 0; n < p; n++) {
                        ...
                        for (y = 0; y < h.length; y++) {
                            ...
                            m.graph && (m.graph.showEventsOnComparedGraphs && m.graph.comparedGraphs[a.id] && (E = !0), (r == m.graph || E) && z >= F && z < v && (q.eventObjects.push(m), q.letters.push(m.text), q.descriptions.push(m.description), m.type ? q.shapes.push(m.type) : q.shapes.push(c.type), void 0 !== m.backgroundColor ? q.backgroundColors.push(m.backgroundColor) :
                                ...
                                void 0 !== m.fontSize && q.fontSizes.push(m.fontSize), q.colors.push(m.color), q.values.push(m.value), !m.panel && m.graph && (m.panel = m.graph.chart), q.showOnAxis.push(m.showOnAxis), q.date = new Date(m.date)));
    ...
    construct: function (a) {
        ...
        if (0 < b.countDataSets("showInCompare") && 1 < k.length)
            if (h ? (AmCharts.addBr(a), AmCharts.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(AmCharts.lang.compareText || b.compareText), a.appendChild(c), l = b.listCheckBoxSize, h) {
                ...
                for (c = 0; c < k.length; c++) g = k[c], !0 === g.showInCompare && g != b.chart.mainDataSet && (d = document.createElement("div"), d.style.padding = "4px", d.style.position = "relative", d.name = "amCBContainer", d.className = e.classNamePrefix + "-compare-item-div", d.dataSet = g, d.style.height = l + "px", g.compared && (d.style.backgroundColor = b.selectedBackgroundColor),
...
AmCharts.StackedBullet = AmCharts.Class({
    construct: function () {
            ...
            this.bullets[c] = m;
            this.showOnAxis ? (n = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY, l = f * e, this.nextAxisY = n + e * d) : this.value ? (n = this.value, h.recalculateToPercents && (n = n / h.recBaseValue * 100 - 100), n = h.getCoordinate(n) - this.bulletY,
                l = f * e) : this.showAt ? (m = this.graphDataItem.values, h.recalculateToPercents && (m = this.graphDataItem.percents), m && (n = h.getCoordinate(m[this.showAt]) - this.bulletY, l = f * e)) : (n = this.nextY, l = f * e);
            a.translate(g, l);
            b.push(a);
            b.translate(0, n);

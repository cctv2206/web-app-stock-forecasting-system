    ...
    construct: function (a) {
        ...
        compareDepth: function (a, b) {
            ...
            for (n = 0; n < b; n++) {
                ...
                if ("none" == f || "3d" == f) {
                    g = !1;
                    for (h = 0; h < d; h++) c = this.graphs[h], c.valueAxis == e && "column" == c.type && (c.clustered ? (c.tcc = 1, c.newStack && (a = 0), c.hidden || (c.columnIndex =
                        a, a++)) : c.hidden || (g = !0, c.tcc = 1, c.columnIndex = 0));
                    g && 0 == a && (a = 1)
                }
                if ("3d" == f) {
                    e = 1;
            ...
            if (d) {
                var c = d.length;
                0 < c && (0 > a && (a = 0), b > c - 1 && (b = c - 1), c = this.categoryAxis, c.parseDates && !c.equalSpacing ?
                    this.zoom(d[a].time, this.getEndTime(d[b].time)) : this.zoom(a, b))
            }
            ...
            if (b) {
                ...
                for (var n = 0; n < d.length; n++) {
                    for (var f = d[n], k = 0, l = 0, m, u, w, q, t, x = 0, p = 0, A, r, v, y, C, D = this.start; D <= this.end; D++) {
                        var z = g[D];
                        if (z && (z = z.axes[e.id].graphs[b.id])) {
                            if (z.values) {
                                ...
                                } else if (0 > z.x || z.x > z.graph.width) B =
                                    NaN;
                                if (!isNaN(B)) {
                                    isNaN(m) && (m = B);
                                    u = B;
                                    if (isNaN(w) || w > B) w = B;
                                    if (isNaN(q) || q < B) q = B;
                                    t = AmCharts.getDecimals(k);
                                    var F = AmCharts.getDecimals(B),
                                        k = k + B,
                                        k = AmCharts.roundTo(k, Math.max(t, F));
                                    l++;
                                    t = k / l
                                }
                            }
            ...
            a = AmCharts.formatValue(a, b.values, e, c, "", this.usePrefixes, this.prefixesOfSmallNumbers,
...
AmCharts.Cuboid = AmCharts.Class({
    construct: function (a, b, d, c, e, g, h, n, f, k, l, m, u, w, q, t, x) {
            this.set = a.set();
            this.container = a;
            this.h = Math.round(d);
            this.w = Math.round(b);
            ...
            if (0 < Math.abs(g) || 0 < Math.abs(h))
                if (isNaN(x)) F = r, r = AmCharts.adjustLuminosity(A, -.2), r = AmCharts.adjustLuminosity(A, -.2), v = AmCharts.polygon(b, [0, g, c + g, c, 0], [0, h, h, 0, 0],
            ...
            !isNaN(x) && (0 < Math.abs(g) || 0 < Math.abs(h)) ? (n = [A], n = {
                ...
                0
            ], [0, e], l, m, k, q) : 0 < w ? AmCharts.rect(b, c, e, n, f, k, l, m, w, u, q) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, e, e, 0, 0], n, f, k, l, m, u, !1, q);
            c = isNaN(x) ? 0 > e ? [v, L, y, C, D, z, B, F, K, b] : [F, K, y, C, D, z, v, L, B, b] : J ? 0 < c ? [v, b, F] : [F, b, v] : 0 > e ? [v, b, F] : [F, b, v];
            AmCharts.setCN(d, b, p + "front");
            AmCharts.setCN(d, y, p + "back");
            AmCharts.setCN(d, F, p + "top");
            AmCharts.setCN(d, v, p + "bottom");
            AmCharts.setCN(d, D, p + "left");
            AmCharts.setCN(d, z, p + "right");
            for (v = 0; v < c.length; v++)
                if (y = c[v]) a.push(y), AmCharts.setCN(d, y, p + "element");
            t && b.pattern(t)
        }, width: function (a) {
            isNaN(a) &&
                (a = 0);
    ...
    construct: function (a) {
            ...
            if (AmCharts.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing) {
                    ...
                    q == e && 1 == u && this.centerLabelOnFullPeriod && (x = w * this.stepWidth);
                    ...
                    var z = d.firstTime,
                        B = 0;
                    p && 1 < u && (y = this.chooseMinorFrequency(u), C = AmCharts.getPeriodDuration(e, y));
                    if (0 < this.gridCountR)
                        for (b = c; b <=
                            ...
                            "MM" == e && (p = (m - l) / w, 1.5 <= (m - l) / w && (m = m - (p - 1) * w + AmCharts.getPeriodDuration("DD", 3), m = AmCharts.resetDateToMin(new Date(m), e, 1).getTime(), B += w));
                            k = (m - this.startTime) * this.stepWidth;
                            p = !1;
                            this.nextPeriod[q] && (p = this.checkPeriodChange(this.nextPeriod[q], 1, m, l, q));
                            v = !1;
                            p && this.markPeriodChange ? (p = this.dateFormatsObject[this.nextPeriod[q]], this.twoLineMode && (p = this.dateFormatsObject[q] + "\n" + p,
                                p = AmCharts.fixBrakes(p)), v = !0) : p = this.dateFormatsObject[q];
                            r || (v = !1);
                            l = AmCharts.formatDate(new Date(m), p, d);
                            if (b == c && !n || b == h && !f) l = " ";
                            this.labelFunction && (l = this.labelFunction(l, new Date(m), this, e, u, t).toString());
                            this.boldLabels && (v = !0);
                            t = new this.axisItemRenderer(this, k, l, !1, x, 0, !1, v);
                            this.pushAxisItem(t);
                            t = l = m;
                            if (!isNaN(y))
                                for (k = 1; k < u; k += y) this.gridAlpha = this.minorGridAlpha, p = m + C * k, p = AmCharts.resetDateToMin(new Date(p), e, y, A).getTime(), p = new this.axisItemRenderer(this, (p - this.startTime) * this.stepWidth),
                                    this.pushAxisItem(p);
                            this.gridAlpha = a
                        }
                } else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(b), b < h && (h = b), g += this.start, this.stepWidth = this.getStepWidth(b), 0 < h)
                        for (h = Math.floor(b / h), y = this.chooseMinorFrequency(h), k = g, k / 2 == Math.round(k / 2) && k--, 0 > k && (k = 0), A = 0, this.end - k + 1 >= this.autoRotateCount && (this.labelRotation = this.autoRotateAngle), b = k; b <= this.end + 2; b++) {
                            r = !1;
                            0 <= b && b < this.data.length ? (q = this.data[b], l = q.category, r = q.forceShow) : l = "";
                            if (p && !isNaN(y))
                                if (b / y == Math.round(b / y) || r) b / h == Math.round(b /
                                    h) || r || (this.gridAlpha = this.minorGridAlpha, l = void 0);
                                else continue;
                            else if (b / h != Math.round(b / h) && !r) continue;
                            k = this.getCoordinate(b - g);
                            t = 0;
                            "start" == this.gridPosition && (k -= this.cellWidth / 2, t = this.cellWidth / 2);
                            r = !0;
                            D = t;
                            "start" == this.tickPosition && (D = 0, r = !1, t = 0);
                            if (b == c && !n || b == this.end && !f) l = void 0;
                            Math.round(A / e) != A / e && (l = void 0);
                            A++;
                            x = this.cellWidth;
                            u && (x = NaN);
                            this.labelFunction && q && (l = this.labelFunction(l, q, this));
                            l = AmCharts.fixBrakes(l);
                            v = !1;
                            this.boldLabels && (v = !0);
                            b > this.end && "start" == this.tickPosition &&
                                (l = " ");
                            t = new this.axisItemRenderer(this, k, l, r, x, t, void 0, v, D, !1, q.labelColor, q.className);
                            t.serialDataItem = q;
                            this.pushAxisItem(t);
                            this.gridAlpha = a
                        }
                    ...
                    if (this.data[k].time != AmCharts.resetDateToMin(new Date(this.data[k].time), e, u, A).getTime())
                        for (A = 0, v = l, b = k; b < x; b++) m =
                            this.data[b].time, this.checkPeriodChange(e, u, m, v) && (A++, 2 <= A && (w = b, b = x), v = m);
                    p && 1 < u && (y = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, y));
                    if (0 < this.gridCountR)
                        for (b = k; b < x; b++)
                            if (m = this.data[b].time, this.checkPeriodChange(e, u, m, l) && b >= w) {
                                ...
                                this.nextPeriod[q] && (p = this.checkPeriodChange(this.nextPeriod[q], 1, m, l, q));
                                v = !1;
                                p && this.markPeriodChange ? (p = this.dateFormatsObject[this.nextPeriod[q]], v = !0) : p = this.dateFormatsObject[q];
                                l = AmCharts.formatDate(new Date(m),
                                    p, d);
                                if (b == c && !n || b == h && !f) l = " ";
                                C ? C = !1 : (r || (v = !1), k - this.previousPos > this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (l = this.labelFunction(l, new Date(m), this, e, u, t)), this.boldLabels && (v = !0), t = new this.axisItemRenderer(this, k, l, void 0, void 0, void 0, void 0, v), p = t.graphics(), this.pushAxisItem(t), t = p.getBBox().width, AmCharts.isModern || (t -= k), this.previousPos = k + t));
                                t = l = m
                            } else isNaN(y) || (this.checkPeriodChange(e, y, m, D) && (this.gridAlpha = this.minorGridAlpha, k = this.getCoordinate(b -
                                this.start), p = new this.axisItemRenderer(this, k), this.pushAxisItem(p), D = m), this.gridAlpha = a)
                }
                ...
                for (b = 0; b < n; b++) f = this.guides[b], r = h = h = a = c = NaN, y = f.above, f.toCategory && (h = d.getCategoryIndexByValue(f.toCategory), isNaN(h) || (c = this.getCoordinate(h - g), f.expand && (c += this.cellWidth / 2), t = new this.axisItemRenderer(this,
                    ...
                    (r = !1), t = "H" == this.orientation ? new this.axisItemRenderer(this, a, f.label, r, 2 * h, NaN, f) : new this.axisItemRenderer(this, a, f.label, !1, NaN, h, f), this.pushAxisItem(t, y)), (0 < c || 0 < a) && (c < this.width || a < this.width) && (c = new this.guideFillRenderer(this, a, c, f), a = c.graphics(), this.pushAxisItem(c, y), f.graphics = a, a.index = b, f.balloonText && this.addEventListeners(a, f))
            }
            this.axisCreated = !0;
            d = this.x;
            g = this.y;
        ...
        getStepWidth: function (a) {
            ...
            var b = this.data,
                ...
                c = d.rotate,
                e = this.stepWidth;
            this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(a / e) -
                this.minDuration() / 2, d = d.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= e / 2), d = this.start + Math.round(a / e));
            ...
            return this.parseDates && !this.equalSpacing ? (a.getTime() - this.startTime) * this.stepWidth : this.parseDates && this.equalSpacing ? (a = this.chart.getClosestIndex(this.data, "time",
                a.getTime(), !1, 0, this.data.length - 1), this.getCoordinate(a - this.start)) : NaN

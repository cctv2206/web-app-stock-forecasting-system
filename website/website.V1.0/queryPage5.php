...
<div id="wrapper">
  ...
  <div id='hahaha'  style="background-color:#f2f2f2;  width:100%">
    <?php
    echo "<br>";
    echo "List the ids of companies along with their name who have the average stock price lesser than the lowest of Google in the latest one year.";
    echo "<br>";
    echo "<br>";
    $test=query::query5("Google");
    echo "<br>";
    ?>
  </div>
